...
若是将这3072个像素上的值用![equation](http://latex.codecogs.com/gif.latex?X=\left[ x_1, & x_2, & ..., & x_n \right]^T)表示，用![equation](http://latex.codecogs.com/gif.latex?n)表示每张图片上的像素数量，![equation](http://latex.codecogs.com/gif.latex?N)表示照片的数量。
