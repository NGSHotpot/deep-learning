...
![equation](http://latex.codecogs.com/gif.latex?P(Y=k|X=X_i)=\frac{exp{s_k}}{\sum_j{exp{s_j}}})
...
![equation](http://latex.codecogs.com/gif.latex?L_i=-\log{P(Y=Y_i|X=X_i)}=-\log{\frac{exp{s_{y_i}}}{\sum_j{exp{s_j}}}})
